            ...
            const { data } = await saveBookMutation({
                variables: {
                    bookData: {
                        ...
                        image: book.image,
                        link: book.link || '', // Ensure link is included, even if empty
                    },
                },
            });
            ...
            return (<Col md="4" key={book.bookId}>
                <Card border='dark'>
                  ...
                  <Card.Body>
                    ...
                    {Auth.loggedIn() && (<Button disabled={savedBookIds?.some((savedBookId) => savedBookId === book.bookId)} className='btn-block btn-info' onClick={() => handleSaveBook(book)}>
